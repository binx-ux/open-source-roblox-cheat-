...
namespace Offsets {
    ...
    namespace Animator {
         inline uintptr_t ActiveAnimations = 0xa20;
    }
    ...
    namespace Attribute {
         ...
         inline uintptr_t TypeDescriptor = 0x8;
    }

    namespace AttributesMap {
         inline uintptr_t Attributes = 0x18; // list start inside AttributeContainer
    ...
    namespace FakeDataModel {
         inline uintptr_t Pointer = 0x84a9e98;
    ...
    namespace RunService {
         inline uintptr_t HeartbeatFPS = 0xb4;
         inline uintptr_t HeartbeatTask = 0xc08;
    }
    ...
    namespace TaskScheduler {
         ...
         inline uintptr_t Pointer = 0x8041ec8;
    }
    ...
    namespace VisualEngine {
         ...
         inline uintptr_t Pointer = 0x81d61c8;
